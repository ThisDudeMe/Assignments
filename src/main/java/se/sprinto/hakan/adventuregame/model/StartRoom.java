...
public class StartRoom implements Room {
    ...
    public void enterRoom(Player player, UI ui) {
        ...
        boolean exit = false;
        while (!exit) {
            String choice = ui.getInput("Vilken dörr vill du ta? (1=Skog, 2=Fängelse, 3=Skattkammare, 4=Trollkarlstorn, 5=Marknad, 6=Bibliotek, q=avsluta)");
            switch (choice) {
                case "1":
                ...
                case "3":
                    ...
                    break;
                case "4":
                    new WizardTowerRoom().enterRoom(player, ui);
                    break;
                case "5":
                    new MarketRoom().enterRoom(player, ui);
                    break;
                case "6":
                    new LibraryRoom().enterRoom(player, ui);
                    break;
                case "q":
                    exit = true;
                    break;
